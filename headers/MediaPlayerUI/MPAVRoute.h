...
-(NSString *)routeUID;
-(id)_initWithAVRouteDescription:(NSDictionary *)routeDescription;
-(void)setWirelessDisplayRoute:(MPAVRoute *)wirelessDisplayRoute;
-(void)setPicked:(BOOL)picked;
-(BOOL)requiresPassword;
-(BOOL)displayIsPicked;
-(NSInteger)passwordType;
-(void)_routingControllerPickedRouteNotification:(NSNotification *)notification;
-(NSString *)_productIdentifier;
-(void)setAVRouteDescription:(NSDictionary *)routeDescription;
-(NSInteger)displayRouteType;
-(void)setDisplayRouteType:(NSInteger)routeType;
